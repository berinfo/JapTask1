    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ingredient>().HasData(
                 new Ingredient { Id = 1, Name = "Oil", Price = 3, Quantity = 1, Unit = UnitEnumeration.l },
                 new Ingredient { Id = 2, Name = "Flour", Price = 30, Quantity = 25, Unit = UnitEnumeration.kg },
                 new Ingredient { Id = 3, Name = "Sugar", Price = 3, Quantity = 1, Unit = UnitEnumeration.kg},
                 new Ingredient { Id = 4, Name = "Salt", Price = 2, Quantity = 1, Unit = UnitEnumeration.kg},
                 new Ingredient { Id = 5, Name = "Olive Oil", Price = 20, Quantity = 1, Unit = UnitEnumeration.l},
                 new Ingredient { Id = 6, Name = "Egg", Price = 9, Quantity = 30, Unit = UnitEnumeration.pcs},
                 new Ingredient { Id = 7, Name = "Chicken meat", Price = 10, Quantity = 1, Unit = UnitEnumeration.kg}
                );
